...
- **Name** Implement Consolidated Task List Output
- **What is needed** Execute the implementation plan to replace the multi-file persistence logic with the single unified task list file output, ensuring compatibility with existing creation and iteration triggers.
- **Skill** implement_code
- **References** [Design Unified Task List Output](task://design-unified-task-list-output.md)
- **Expected output** Updated Vala source files implementing the consolidated task list logic.
