...
namespace OLLMfilesd.Vector
{
	 ...
	 */
	public class DocumentationAnalysis : OLLMvector2.VectorBase
	{
		...
		private async void analyze_document(
			OLLMvector2.SQT.VectorMetadata root_element, 
		...
		private async void analyze_sections(DocumentationTree tree) throws GLib.Error
		{
			...
			var sections_to_process = new Gee.ArrayList<OLLMvector2.SQT.VectorMetadata>();
