...
namespace OLLMtools
{
	 ...
	 */
	public class GoogleSearchConfig : Object, Json.Serializable
	{
		/**
		...
		/**
		 * Loads GoogleSearchConfig from file.
		 *
		 * Loads from ~/.config/ollmchat/google.json
		 * If the file cannot be read/parsed, returns null.
		 *
		 * @return A new GoogleSearchConfig instance loaded from the file, or null if loading failed
		 */
		public static GoogleSearchConfig? load()
		{
