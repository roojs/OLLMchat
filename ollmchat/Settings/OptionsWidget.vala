...
namespace OLLMchat.Settings
{
	...
	{
		public Gee.ArrayList<OptionRow> option_rows { get; private set; default = new Gee.ArrayList<OptionRow>(); }

		public OptionsWidget(OLLMchat.Call.Options options)
		{
			Object(orientation: Gtk.Orientation.VERTICAL);
			this.create_option_rows(options);
		}

		private void create_option_rows(OLLMchat.Call.Options options)
		{
