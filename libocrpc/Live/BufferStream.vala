...
namespace OLLMrpc.Live
{
	 ...
	 * socket. {@link OLLMrpc.Transport.Connection} and {@link OLLMrpc.Client} hold
	 * one instance when fd passing is enabled.
	 */
	public class BufferStream : GLib.Object
	{
		...
		/**
		 * ''sendmsg'' one fd on the fd channel (server). Call before the matching
		 * {@link OLLMrpc.Notification} on the main socket.
		 */
