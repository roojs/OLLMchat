 ...
 *
 * This file is the Linux AT-SPI implementation. Windows (5.0.1) is expected
 * to supply a drop-in replacement with the same API — do not ifdef here.
 * Dump tree walking lives in {@link A11yParse}. Work runs on a worker
 * thread (main-thread AT-SPI deadlocks). Set ''GTK_A11Y=atspi'' before
 * GTK init. No page JavaScript.
 *
 * == Example ==
 *
 * {{{
...
public class OLLMwebkit.A11y : GLib.Object
{
	 ...
	 * @throws GLib.Error when the AT-SPI tree cannot be read
	 */
	...
	/**
	 * Fill press-refs via AT-SPI focus + keyboard synthesis.
	 *
	...
	/**
	 * Activate a press-ref via AT-SPI Action.
	 *
	...
	/**
	 * Worker-thread body for {@link dump}.
	 *
	 * @param url current page URL
	...
	/**
	 * Worker-thread body for {@link fill}.
	 *
	...
	/**
	 * Worker-thread body for {@link press}.
	 *
	 * @param id press id from the last dump
	 * @throws GLib.Error when the ref is missing or action fails
	 */
