# 04. What Pi’s “harness” actually does

Status: ⏳ study (not an implement plan)

ℹ️ Parent: [02-pi-like-agent.md](02-pi-like-agent.md). Prior: [01-pi-agent.md](01-pi-agent.md), [03-base-skills.md](03-base-skills.md).  
...
- ℹ️ **Pi does not harness model output quality.** No plan gate, no skill-was-followed check, no RAPIR stages, no host retry that “you skipped the skill.” Soft skills fail open ([01 §4](01-pi-agent.md#4-skills-in-pi--catalog-cheap-body-on-demand)).
...
- ℹ️ What *is* adjacent and more interesting: **extensions** (code hooks in the loop) vs **skills** (markdown playbooks). We skipped Pi extensions ([02 Out of this plan](02-pi-like-agent.md#out-of-this-plan)). That skip removes most of Pi’s “build your own governance” story.
...
4. **Context-file contract** — `AGENTS.md` always-inlined; skills progressive — clean prompt pattern ([01](01-pi-agent.md)).
...
2. **Skills pack** = playbooks; value is curation + tool retarget ([03](03-base-skills.md)), not a new control plane.
