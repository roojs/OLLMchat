...
**Status:** **ON HOLD** — OLLMchat app opt-in landed (steps 1–6 ✔️); **smoke / sign-off** blocked on Linux until [webkitgtk-automation](https://github.com/roojs/webkitgtk-automation) exposes GTK `WebKitSettings` for `NavigatorWebDriverActivePolicy` ([`2026-09-02-webkit-automation-leaks-into-client-sites.md`](../bugs/2026-09-02-webkit-automation-leaks-into-client-sites.md)). Win/Android hide is wired; requires **webview2-gtk ≥ 0.5.9** / **webkitgtk-android ≥ 0.1.5**.
...
7. **⏸️ ON HOLD** **🔷** Smoke: Google fill + press on Linux, Windows, and Android — Win/Android `navigator.webdriver` hide wired; Linux still **Auto** until GTK Settings API ([`2026-09-02-webkit-automation-leaks-into-client-sites.md`](../bugs/2026-09-02-webkit-automation-leaks-into-client-sites.md)).
