...
```vala
private static int64 get_max_last_modified(SQ.Database db) {
...
private bool needs_reload() {
    ...
    var max_mtime = Folder.get_max_last_modified(this.manager.db);
...
- [libocfiles/Folder.vala](libocfiles/Folder.vala)
  - Add `get_max_last_modified()` static helper method
