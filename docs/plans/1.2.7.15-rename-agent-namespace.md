...
⏳ **IN PROGRESS** - Finalizing naming strategy and method lists.
...
10. ⏳ Remove old files from meson.build:
    - Remove `libollmchat/Prompt/BaseAgent.vala`
    - Remove `libollmchat/Prompt/AgentHandler.vala`
    - Remove `libollmchat/Prompt/JustAsk.vala`
    - Remove `liboccoder/Prompt/CodeAssistant.vala`
    - Remove `liboccoder/Prompt/CodeAssistantHandler.vala`
    - Remove `liboccoder/Prompt/CodeAssistantProvider.vala`
...
### Phase 1 Testing
- [ ] New files created and compile successfully
- [ ] Old files still compile (both exist in build)
