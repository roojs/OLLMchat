...
2. **[1.2.7.2. Add Signals to Chat](./1.2.7.2-add-signals-to-chat.md)** - Add signal declarations and emissions to Chat
3. **[1.2.7.3. Update Agent Usage to Direct Method Calls](./1.2.7.3-update-agent-usage-direct-calls.md)** - Replace signal connections with direct method calls for agent usage
