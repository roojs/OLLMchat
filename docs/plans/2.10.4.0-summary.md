...
| Plan | Status | Topic |
|------|--------|-------|
| [`2.10.4.30-ACTIVE-startup-and-daemon-status-ui.md`](2.10.4.30-ACTIVE-startup-and-daemon-status-ui.md) | **ACTIVE** — Phases 1–3 ✔️ | Startup overlay (Ollama + daemon) + daemon activity status bar |
