...
- **✔️** Meson **`v2testing`** source swaps applied; default **`true`** ([`2.10.4.21`](2.10.4.21-ACTIVE-meson-v2-cutover.md)).
...
- **[`2.10.4.27-ACTIVE-rpc-client-cleanup-and-wire-registration.md`](2.10.4.27-ACTIVE-rpc-client-cleanup-and-wire-registration.md)** — delete orphan **`RpcClient.vala`**; wire **`rpc_register`** in PM ctor (**✔️** code; smoke **⏳**)
