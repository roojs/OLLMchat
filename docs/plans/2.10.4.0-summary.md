...
- **[`2.10.4.29-ACTIVE-vector-cli-rpc-migration.md`](2.10.4.29-ACTIVE-vector-cli-rpc-migration.md)** — **`Codebase.get`** / **`reset`** / **`start`** / **`stop`** on **`Codebase.vala`**; **`CodebaseSearch`** tool **✅**; rewrite CLIs (**blocks** V1 **`libocvector`**)
...
| [`done/2.10.4.18-DONE-vector-search-rpc.md`](done/2.10.4.18-DONE-vector-search-rpc.md) | **DONE** | **`Codebase.search`**; admin/index → **2.10.4.29** |
