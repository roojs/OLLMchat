...
**Status:** index — maps tranche **2.10.4**; **one ACTIVE implementation plan** below
...
- **🔷** App still links **shipping** `libocfiles/*.vala` until Meson flip.
...
- **[`2.10.4.21-ACTIVE-meson-v2-cutover.md`](2.10.4.21-ACTIVE-meson-v2-cutover.md)** — Meson flag, V2 source list swap, spawn **`ollmfilesd`**, drop in-process scan
