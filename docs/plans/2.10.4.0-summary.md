...
| [`2.10.4.7-URGENT-active-project-file-outside-db.md`](2.10.4.7-URGENT-active-project-file-outside-db.md) | **URGENT** | Active project/file off daemon; Config2 `Window` map; Phase 0 = drop `File.activate` (crash) |
