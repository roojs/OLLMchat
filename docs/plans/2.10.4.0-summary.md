...
| [`2.10.4.32-FUTURE-multi-window-support.md`](2.10.4.32-FUTURE-multi-window-support.md) | **FUTURE** | Second GTK window + per-window `Config2.windows` rows |
...
- [`done/2.10.4.7-DONE-active-project-file-outside-db.md`](done/2.10.4.7-DONE-active-project-file-outside-db.md) — active project/file off daemon; Config2 `Window`; Phases 0–3; multi-window → [`2.10.4.32`](2.10.4.32-FUTURE-multi-window-support.md)
