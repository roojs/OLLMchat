...
**Status:** **APPROVED** (2026-06 review).

**Parent:** [`2.10.4.9-v2-wiring-and-cutover.md`](2.10.4.9-v2-wiring-and-cutover.md)

**Implement order:** [`2.10.4.9.3`](2.10.4.9.3-daemon-rpc-and-meson-cutover.md) wire hunks **first**, then this doc §Concrete code proposals, then [`2.10.4.9.2`](2.10.4.9.2-reshape-callers.md).
