...
⏳ **TODO** - Planning document for configuration interface implementation.
...
ollmchat/
├── Settings/
│   ├── SettingsDialog.vala          # Main dialog window (Adw.Dialog/Window)
│   ├── ConnectionsPage.vala          # Connections tab (Adw.PreferencesPage)
│   ├── ModelsPage.vala               # Models tab (Adw.PreferencesPage)
│   ├── ToolsPage.vala                # Tools tab (Adw.PreferencesPage)
│   ├── ModelUsageEditor.vala         # Reusable ModelUsage editor (Adw.PreferencesGroup)
│   └── OptionsEditor.vala            # Reusable Call.Options editor (Adw.PreferencesGroup)
```
