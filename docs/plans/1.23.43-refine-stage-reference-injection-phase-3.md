...
**Verdict:** Phase **3** fences in this document (**resource**, **`gresources.xml`**, **`header_file`**, **`reference_content`**) are implemented in the repo. Automated **Tests / behaviour checks** (plan § end) remain manual / follow-up unless covered elsewhere.
