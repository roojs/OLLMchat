...
| # | Plan | Summary |
| --- | --- | --- |
| **1a** | [`7.16.1-action-copy.md`](7.16.1-action-copy.md) | **Copy** today’s execution into **`Action.*`** — **not wired**, not in build |
| **1b** | [`7.16.1b-action-wire.md`](7.16.1b-action-wire.md) | Wire **`run_action`**, **`meson.build`**, trim **`Details`** — **after review** |
...
- **🔷** All runners **extend `Action.Base`**; **`Details.run_action`** picks runner (**no `Factory.vala`**).
