...
### Move to `docs/APP-5.7-building-windows.md` (this file, promoted when done)
...
creating-releases.md then ends with: *“For local builds see [APP-5.7-building-windows.md](APP-5.7-building-windows.md) and [building-linux.md](building-linux.md).”*
