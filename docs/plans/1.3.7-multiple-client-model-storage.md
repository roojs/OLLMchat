...
✅ **Phase 4 Complete** - Integration with SettingsDialog.Rows.Model widget.
❌ **Phase 5 Not Done** - Integration with ModelsPage - needs proper implementation using ListModel without copying data.
