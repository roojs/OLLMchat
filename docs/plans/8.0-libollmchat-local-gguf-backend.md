...
- **ℹ️** Daemon [`2.10.4.0-ACTIVE-summary`](2.10.4.0-ACTIVE-summary.md) single-thread `BackgroundScan` depends on Phase 3 threading — do not cut over embed connection before `Thread` ships.
