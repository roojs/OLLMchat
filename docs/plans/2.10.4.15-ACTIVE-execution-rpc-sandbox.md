...
**Status:** deferred — **`ollmfilesd` phase 2** (execution / sandbox RPC). **`libocbwrap`** ✅ ([`done/2.10.4.17`](done/2.10.4.17-DONE-libocbwrap-sandbox-library.md)); **implement after** in-app caller repoint ([`2.10.4.9`](2.10.4.9-ACTIVE-v2-caller-cutover.md) step 4)
...
**`libocbwrap`** ✅ ([`done/2.10.4.17`](done/2.10.4.17-DONE-libocbwrap-sandbox-library.md)) — in-app repoint next ([`2.10.4.9`](2.10.4.9-ACTIVE-v2-caller-cutover.md) step 4)
...
2. **⏳** Repoint **`liboctools`**, **`libocmcp`** to **`OLLMbwrap`** ([`2.10.4.9`](2.10.4.9-ACTIVE-v2-caller-cutover.md) step 4)
