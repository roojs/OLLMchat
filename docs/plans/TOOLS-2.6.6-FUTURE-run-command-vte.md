...
> Split from `TOOLS-2.6.4-URGENT-run-command-stop-live-tail-spill.md`. Done Stop/tail/frame: [`done/TOOLS-2.6.4-DONE-run-command-stop-and-tail.md`](done/TOOLS-2.6.4-DONE-run-command-stop-and-tail.md). Done timeout / live / spill: [`done/TOOLS-2.6.5-DONE-run-command-timeout-live-spill.md`](done/TOOLS-2.6.5-DONE-run-command-timeout-live-spill.md). Libsecret + hold: [`done/TOOLS-2.6.7-DONE-run-command-libsecret-hold.md`](done/TOOLS-2.6.7-DONE-run-command-libsecret-hold.md).
