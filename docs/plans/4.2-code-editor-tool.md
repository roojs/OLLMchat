...
⏳ **TODO** - ProjectMigrate class not yet implemented.
...
🟡 **PARTIALLY DONE** - FileBase has database methods (initDB, saveToDB), but ProjectManager lacks background sync and file system watcher.
...
⏳ **TODO** - ProjectDropdown and FileDropdown widgets not yet implemented.
