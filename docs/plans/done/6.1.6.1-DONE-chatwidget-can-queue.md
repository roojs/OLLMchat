...
ℹ️ Parent: [`../6.1.6-urgent-follow-up.md`](../6.1.6-urgent-follow-up.md). Agent bind / visibility / session switch: [`../6.1.6.2-agent-queue-session.md`](../6.1.6.2-agent-queue-session.md).  
