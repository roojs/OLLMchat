...
**Next:** [`2.10.4.9-DONE-v2-caller-cutover.md`](../2.10.4.9-DONE-v2-caller-cutover.md) — callers + Meson
...
**Why:** Session restore uses saved paths, not daemon index ([`2.10.4.7`](2.10.4.7-FUTURE-active-project-file-outside-db.md) later).
...
**Why:** Replace all `project_files.*` access from callers ([`2.10.4.9-DONE-v2-caller-cutover.md`](../2.10.4.9-DONE-v2-caller-cutover.md)).
