...
**Next:** [`2.10.4.9.2`](../2.10.4.9.2-reshape-callers.md) callers · Meson in [`2.10.4.9.3`](../2.10.4.9.3-daemon-rpc-and-meson-cutover.md)
...
- **🔷** Stage 3 wire before client/caller edits ([`2.10.4.9.3`](../2.10.4.9.3-daemon-rpc-and-meson-cutover.md)).
...
Implement on daemon in [`2.10.4.9.3`](../2.10.4.9.3-daemon-rpc-and-meson-cutover.md) before client hunks below.
...
**Depends on:** [`2.10.4.9.3`](../2.10.4.9.3-daemon-rpc-and-meson-cutover.md) §1 `Folder.fetch` relay.
...
**Why:** Replace all `project_files.*` access from callers ([`2.10.4.9.2`](../2.10.4.9.2-reshape-callers.md)).

**Where:** `Folder` class, before the closing `}` of the class (after last existing method).

**Depends on:** [`2.10.4.9.3`](../2.10.4.9.3-daemon-rpc-and-meson-cutover.md) wire relays; strip client `Folder` per [`2.10.4.5`](done/2.10.4.5-DONE-folder.md) if still not applied.
