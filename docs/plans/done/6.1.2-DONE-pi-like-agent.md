...
ℹ️ Parent: [6.1](../6.1-agent-pi.md). Study: [6.1.1](../6.1.1-pi-agent.md); harness: [6.1.4](../6.1.4-pi-harness-what-it-actually-does.md).  
...
ℹ️ Remaining (sibling plans): [6.1.9](../6.1.9-offer-agents-md.md), [6.1.10](../6.1.10-skills-configuration.md), [6.1.11](../6.1.11-extended-base-skills.md).  
ℹ️ Optional later (not split): Pi-style exact **`edit`** tool; AGENTS inject soft-cap (% of context) after [09](../6.1.9-offer-agents-md.md).
...
- ℹ️ Open work lives in [09](../6.1.9-offer-agents-md.md) / [10](../6.1.10-skills-configuration.md) / [11](../6.1.11-extended-base-skills.md) (plus optional edit / AGENTS soft-cap notes above).
...
- **🚫** Fake AGENTS path / `agent/` subdir / size policy (size = after [09](../6.1.9-offer-agents-md.md)).
- **ℹ️** Offer-to-create: [09](../6.1.9-offer-agents-md.md).
...
- **🔷** User edit path: config **Export** resource → filesystem — still [6.1.10](../6.1.10-skills-configuration.md).
- **🔷** `⏳` **Initial offer** (subset of available → `{skills_md}`) + settings UI: [6.1.10](../6.1.10-skills-configuration.md).
- **🔷** `⏳` Extended / deferred skills (subagent-delegate, skipped superskills, …): [6.1.11](../6.1.11-extended-base-skills.md).
...
- **💩** Default tool subset ([2.30](../2.30-pretooler-tool-filtering.md)) — optional, not the core of Phase 3.
...
Study refs (background only): [01 §7](6.1.1-pi-agent.md#7-context-growth-pi-compaction-vs-chatter); Pi `packages/coding-agent/src/core/compaction/`; hash/`session_fetch` patterns in [2.31](../2.31-just-ask-summary-history.md). **🚫** Slash `/compact` — we do not support slash commands.
...
- **ℹ️** Project-summary tool: [07](6.1.7-DONE-project-summary-tool.md).
- **ℹ️** Offer to create `AGENTS.md`: [09](../6.1.9-offer-agents-md.md).
...
1. [10](../6.1.10-skills-configuration.md) — initial offer + export UI  
2. [11](../6.1.11-extended-base-skills.md) — extended / deferred skills  
3. [09](../6.1.9-offer-agents-md.md) — offer to create `AGENTS.md`  
4. After [09](../6.1.9-offer-agents-md.md) — AGENTS inject soft-cap (% of context)  
...
- **ℹ️** Study: [6.1.1](../6.1.1-pi-agent.md); siblings [03](6.1.3-DONE-base-skills.md), [04](../6.1.4-pi-harness-what-it-actually-does.md), [06](6.1.6-DONE-urgent-follow-up.md) (+ [6.1.6.1](6.1.6.1-DONE-chatwidget-can-queue.md) / [6.1.6.2](6.1.6.2-DONE-agent-queue-session.md) / [6.1.6.3](6.1.6.3-DONE-agent-session-switch.md)), [07](6.1.7-DONE-project-summary-tool.md), [09](../6.1.9-offer-agents-md.md), [10](../6.1.10-skills-configuration.md), [11](../6.1.11-extended-base-skills.md).
...
- **ℹ️** Chatter kernel: `libollmchat/Chatter/`, [2.31](../2.31-just-ask-summary-history.md).
