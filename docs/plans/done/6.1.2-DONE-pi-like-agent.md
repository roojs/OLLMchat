...
Study refs (background only): [01 §7](CODER-6.1.1-pi-agent.md#7-context-growth-pi-compaction-vs-chatter); Pi `packages/coding-agent/src/core/compaction/`; hash/`session_fetch` patterns in [2.31](../CHAT-2.31-just-ask-summary-history.md). **🚫** Slash `/compact` — we do not support slash commands.
...
- **ℹ️** Chatter kernel: `libollmchat/Chatter/`, [2.31](../CHAT-2.31-just-ask-summary-history.md).
