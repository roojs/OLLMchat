...
- [x] Add 'file' to VALID_ELEMENT_TYPES (libocvector/Tool/RequestCodebaseSearch.vala - add 'file' to array)
- [x] Update CodebaseSearchTool parameter description (libocvector/Tool/CodebaseSearchTool.vala - add 'file' to supported types list)
- [x] Update command line search tool help text (examples/oc-vector-search.vala - add 'file' to element type examples in help and option descriptions)
- [x] Add ast-path to search result output (libocvector/Tool/RequestCodebaseSearch.vala - update format_results() to include ast-path line when ast_path is not empty)
