...
- ℹ️ Windows / Android: [`5.0.1-DONE-windows-webkit-accessibility.md`](5.0.1-DONE-windows-webkit-accessibility.md), [`5.0.2-DONE-android-webkit-control.md`](5.0.2-DONE-android-webkit-control.md)
...
- **ℹ️** History / open → **[`5.0.7`](../WEBKIT-5.0.7-DEFERRED-webkit-download-advanced.md)**. Cancel button → **[`5.0.6`](5.0.6-DONE-activity-progress-actions.md)** (`downloads_active`) — **✅**.
