...
**Coding standards:** Follow `docs/coding-standards.md`. This plan uses: **this.** for instance members; **var** for initializers where type not required; fill() with one key, value per line; no trailing null (Vala adds for varargs); **GLib.Error**; no underscore names; no get_* for simple accessors.
...
**Status:** Partially implemented. Completed work is in **1.23.14-outstanding** (definition fetching, resolving references, current file, validate tasks, skill catalog). Remainder → **[1.23.18 DONE](1.23.18-DONE-tail-end-issues.md)**.
...
**Remaining (→ [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md)):**
- **validate_task_list_reference_lengths(TaskList)** — Runner method; align with Details resolution. See [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md) §3.
- **Naming:** run_until_user_approval → run_until_writer; has_tasks_requiring_approval → has_writer_tasks. See [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md) §4.
- **Task naming and output references** (#slug-number-results, output: resolution). See [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md) §1.
- **validate_reference_targets** #anchor validation. See [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md) §2.
...
- **Entry and loop**
  ...
  - **Validate reference content length:** Not yet implemented. When added, Runner **validate_task_list_reference_lengths(TaskList)** per [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md) §3.
...
**Proposed code — send_async and handle_task_list** (naming run_until_writer / has_writer_tasks to be aligned per [1.23.18 DONE](1.23.18-DONE-tail-end-issues.md) §4; current code uses run_until_user_approval / has_tasks_requiring_approval):
...
- **validate_task_list_reference_lengths(TaskList)** — Not implemented. See **[1.23.18 DONE](1.23.18-DONE-tail-end-issues.md)** §3.
...
- **[1.23.18 DONE](1.23.18-DONE-tail-end-issues.md)** — Remaining tasks (task naming, validate_reference_targets #anchor, validate_task_list_reference_lengths, naming alignment).
