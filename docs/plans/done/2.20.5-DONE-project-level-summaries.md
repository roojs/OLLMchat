...
Before implementing, verify this plan adheres to the coding standards in [docs/coding-standards.md](docs/coding-standards.md):
...
- 2.20-DONE-codebase-scanner-improvements.md
