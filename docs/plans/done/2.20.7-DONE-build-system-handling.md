...
This plan follows the coding standards defined in `docs/coding-standards.md`. All code examples in this document should:
...
**File**: `resources/ocvector/analysis-prompt-doc-file.txt`
...
| File | Change |
|------|--------|
| resources/ocvector/analysis-prompt-doc-file.txt | Add "build" category; 8→9 in four places |
...
- [x] analysis-prompt-doc-file.txt: add "build"; 8→9 in four places
