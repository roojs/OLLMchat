# 1.23.2 DONE — Three prompt types and orchestration (archived)

**Status: DONE.** Implemented via DONE sub-plans 1.23.3–1.23.6, 1.23.11; prompts in `resources/skill-prompts/` (`task_creation_initial`, `task_refinement`, `task_list_iteration`, `task_execution`). Runner = orchestrator.
...
- **Prompts** live under **`resources/skill-prompts`:** `task_creation_initial.md`, `task_refinement.md`, **`task_list_iteration.md`** (intermediary / post-step list update; role of former `task_post_completion`), `task_execution.md`.
...
|----------|--------|-------------------------|
| **1.23.3** | [DONE](1.23.3-DONE-task-creation-initial-prompt.md) | Task creation (initial) prompt. |
| **1.23.4** | [DONE](1.23.4-DONE-task-refinement-prompt.md) | Task refinement prompt. |
| **1.23.5** | [DONE](1.23.5-DONE-task-creation-continuation-prompt.md) | Continuation / iteration prompt (**task_list_iteration.md**). |
| **1.23.6** | [DONE](1.23.6-DONE-task-execution-prompt.md) | Task execution prompt. |
| **1.23.11** | [DONE](1.23.11-DONE-runner-implementation.md) | Runner implementation. |
| **1.23.12** | [DONE](1.23.12-DONE-prompt-refinements-from-design.md) | Prompt refinements from design. |
