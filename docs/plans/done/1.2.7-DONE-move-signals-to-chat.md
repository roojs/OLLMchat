...
✅ **DONE** - All signal migration complete. All subplans (1.2.7.1 through 1.2.7.22) have been completed.
...
4. **[1.2.7.4. Migrate Non-Agent Signal Connections](./1.2.7.4-DONE-migrate-non-agent-signals.md)** - Update non-agent code to connect to Chat signals
5. **[1.2.7.5. Rename exec_chat() to send()](./1.2.7.5-DONE-rename-exec-chat-to-send.md)** - Align method name with plan 1.2's ideal interface
...
7. **[1.2.7.7. Remove Client from Session](./1.2.7.7-DONE-remove-client-from-session.md)** - Final tidy-up: remove client property from SessionBase
...
11. **[1.2.7.11. Consider Moving fetch_all_model_details to Connection](./1.2.7.11-consider-moving-fetch-all-model-details.md)** - Consider moving fetch_all_model_details() from Client to Connection
12. **[1.2.7.12. ChatInput Model Update](./1.2.7.12-DONE-chatinput-model-update.md)** - Update ChatInput to use Session model
13. **[1.2.7.13. Implement BaseAgent System Message](./1.2.7.13-DONE-implement-baseagent-system-message.md)** - Implement system message handling in BaseAgent
14. **[1.2.7.15. Rename Agent Namespace](./1.2.7.15-DONE-rename-agent-namespace.md)** - Rename agent namespace
15. **[1.2.7.16. Remove Session Replaced Signal](./1.2.7.16-DONE-remove-session-replaced-signal.md)** - Remove session_replaced signal
16. **[1.2.7.17. Remove Session Added Signal](./1.2.7.17-DONE-remove-session-added-signal.md)** - Remove session_added signal
17. **[1.2.7.18. ChatView.append_complete_assistant_message()](./1.2.7.18-chatview-append-complete-assistant-message.md)** - Remove Chat/Response.Chat dependency from history rendering
18. **[1.2.7.19. Remove Unused Chat Parameter](./1.2.7.19-remove-unused-chat-parameter.md)** - Remove unused chat parameter
19. **[1.2.7.20. Inline Temporary Variables](./1.2.7.20-inline-temporary-variables.md)** - Inline temporary variables
20. **[1.2.7.21. Support Non-Agentic Tools](./1.2.7.21-support-non-agentic-tools.md)** - Support non-agentic tools
21. **[1.2.7.22. Investigate Removing message_interface](./1.2.7.22-investigate-remove-message-interface.md)** - Investigate whether message_interface can be removed from Message class
...
- [1.2. Refactor Client and Chat Relationship](./1.2-DONE-refactor-client-chat-relationship.md) - Parent plan
