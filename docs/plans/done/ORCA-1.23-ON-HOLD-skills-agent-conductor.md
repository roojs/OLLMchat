...
1. Add **SkillRunner** and **SkillRunnerFactory** in liboccoder (mirror JustAsk pattern; system prompt from skill file under `{HOME}/gitlive/OLLMchat/resources/skills`). **→ Full concrete code: [1.23.1 DONE](done/1.23.1-DONE-skill-runner-occoder.md)**
