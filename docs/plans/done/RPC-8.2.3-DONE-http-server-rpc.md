...
**Builds on:** [`RPC-8.2.1-libocrpc-auto-json-and-http-client.md`](../RPC-8.2.1-libocrpc-auto-json-and-http-client.md) (`Bin.Json` AUTO + HTTP **client**), [`8.2.2-DONE-proper-bin-json-streaming.md`](8.2.2-DONE-proper-bin-json-streaming.md)
...
- **🔷** Streaming JSON / bin+session / HTTPS — **done**:
  - [`done/RPC-8.2.3.1-DONE-http-json-streaming.md`](RPC-8.2.3.1-DONE-http-json-streaming.md)
  - [`done/RPC-8.2.3.2-DONE-http-bin-session.md`](RPC-8.2.3.2-DONE-http-bin-session.md)
  - [`done/RPC-8.2.3.4-DONE-http-client.md`](RPC-8.2.3.4-DONE-http-client.md)
  - [`done/RPC-8.2.3.5-DONE-https-server.md`](RPC-8.2.3.5-DONE-https-server.md)
  - [`done/RPC-8.2.3.6-DONE-https-client.md`](RPC-8.2.3.6-DONE-https-client.md)
...
2. [`done/RPC-8.2.3.1-DONE-http-json-streaming.md`](RPC-8.2.3.1-DONE-http-json-streaming.md) — streaming JSON — `✔️`
3. [`done/RPC-8.2.3.3-DONE-http-path-type-registration.md`](RPC-8.2.3.3-DONE-http-path-type-registration.md) — path ↔ request/response types — `✔️`
4. [`done/RPC-8.2.3.2-DONE-http-bin-session.md`](RPC-8.2.3.2-DONE-http-bin-session.md) — bin over HTTP + session id — `✔️`
5. [`done/RPC-8.2.3.4-DONE-http-client.md`](RPC-8.2.3.4-DONE-http-client.md) — separate `Transport.HttpClient` — `✔️`
6. [`done/RPC-8.2.3.5-DONE-https-server.md`](RPC-8.2.3.5-DONE-https-server.md) — HTTPS server (TLS listen + product CA) — `✔️`
7. [`done/RPC-8.2.3.6-DONE-https-client.md`](RPC-8.2.3.6-DONE-https-client.md) — HTTPS client (trust store) — `✔️`
...
- **🚫** Streaming JSON — **[`8.2.3.1`](RPC-8.2.3.1-DONE-http-json-streaming.md)** (not in Phase 1 unary Hello World).
- **🚫** Extending `OLLMrpc.Client` for POST-to-our-server — Phase 1 smoke uses `Soup.Session` (or curl) in the test; dedicated client is **[`8.2.3.4`](RPC-8.2.3.4-DONE-http-client.md)**.
- **🚫** Sessions, bin Content-Type — **[`8.2.3.2`](RPC-8.2.3.2-DONE-http-bin-session.md)**; TLS — Phase 4; client-cert auth — **8.2.7**.
...
## Phase 2 — Streaming JSON → [`RPC-8.2.3.1`](RPC-8.2.3.1-DONE-http-json-streaming.md)

- **ℹ️** Split out — NDJSON proposals live in that plan (not duplicated here).

---

## Phase 3 — Bin + session → [`RPC-8.2.3.2`](RPC-8.2.3.2-DONE-http-bin-session.md)

- **ℹ️** Split out — session table + bin Content-Type live in that plan.

---

## Phase 4 — HTTPS → [`RPC-8.2.3.5`](RPC-8.2.3.5-DONE-https-server.md) + [`RPC-8.2.3.6`](RPC-8.2.3.6-DONE-https-client.md)
