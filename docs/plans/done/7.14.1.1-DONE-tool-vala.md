...
**Status:** proposed · **Parent:** `docs/plans/done/7.14.1-DONE-progresslist-runner.md` · **Depends on:** `docs/plans/done/7.14.1-DONE-phase1-core.md` (`EXECUTION_RETRY`, `ProgressItem`, `to_human()`)
...
`docs/plans/done/7.14.1.3-DONE-details-vala.md` · `docs/plans/done/7.14.1.2-DONE-runner-vala.md` · `docs/plans/7.14.5` (replay / `in_replay`)
