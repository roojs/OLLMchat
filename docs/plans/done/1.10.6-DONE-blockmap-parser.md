...
Code in this plan follows **docs/coding-standards.md** (no one-use temporaries or trivial aliases; `this.` for instance members; `GLib.` prefix; brace style; no character loops; regex for separator check).
