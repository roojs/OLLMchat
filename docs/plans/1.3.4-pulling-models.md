...
🚧 **IN PROGRESS** - Core UI components completed, background pull operations pending
...
4. **Create `AddModelDialog` class** (`ollmchat/Settings/AddModelDialog.vala`) ✅ **COMPLETED**
   ...
   - Three rows in `Adw.PreferencesGroup`:
     ...
     4. **Start Download button** (in footer `Adw.PreferencesGroup`):
        ...
        - ⏳ **TODO**: Wire up to `ModelPullManager` in Phase 5 to start pull operation
...
- `ollmchat/Settings/ModelPullManager.vala` - Manages background pull operations ⏳ **NOT STARTED**
