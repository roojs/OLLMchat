...
**Parent:** `docs/plans/OLLAMA-4.8-ollama-web-live-search.md` (Phase 1 ✅, Phase 2.1 ✅)
...
| **Edit** | `docs/plans/OLLAMA-4.8-ollama-web-live-search.md` — link Phase 2.3 / pull-from-catalog |
