...
ℹ️ Study: [6.1.1](6.1.1-pi-agent.md); harness meaning: [6.1.4](6.1.4-pi-harness-what-it-actually-does.md). Vala: `docs/coding-standards.md` via router when implementing.  
ℹ️ Parent: [6.1](6.1-agent-pi.md). Split-outs: [6.1.6](6.1.6-urgent-follow-up.md), [6.1.7](6.1.7-project-summary-tool.md), [6.1.9](6.1.9-offer-agents-md.md); base skills [6.1.3](6.1.3-base-skills.md).
...
- **⏳** Remaining backlog lives in sibling plans ([06](6.1.6-urgent-follow-up.md) / [6.1.6.2](6.1.6.2-agent-queue-session.md) / [6.1.6.3](6.1.6.3-agent-session-switch.md), [07](6.1.7-project-summary-tool.md), [09](6.1.9-offer-agents-md.md), [03](6.1.3-base-skills.md)); lock policy there, then implement.
...
- **ℹ️** Research / options: [6.1.3](6.1.3-base-skills.md) — collections, acquisition open (vendor vs seed vs docs-only; **🚫** npm).
...
- **ℹ️** Urgent / follow-up (agent + UI): [06](6.1.6-urgent-follow-up.md).
- **ℹ️** Project-summary tool: [07](6.1.7-project-summary-tool.md).
...
6. [06](6.1.6-urgent-follow-up.md) — urgent/follow-up (6a agent, then 6b UI)  
7. [07](6.1.7-project-summary-tool.md) — project-summary tool  
8. [09](6.1.9-offer-agents-md.md) — offer to create `AGENTS.md`  
9. After [09](6.1.9-offer-agents-md.md) — AGENTS inject soft-cap as a % of active model context  

---

## LLM notes

- **ℹ️** Study: [6.1.1](6.1.1-pi-agent.md); siblings [03](6.1.3-base-skills.md), [04](6.1.4-pi-harness-what-it-actually-does.md), [06](6.1.6-urgent-follow-up.md), [07](6.1.7-project-summary-tool.md), [09](6.1.9-offer-agents-md.md).
