...
- `liboctools/meson.build` - Add `RunCommand/Overlay.vala` to `octools_src` list (after `RunCommand/Monitor.vala`, before `RunCommand/Request.vala`)
- `docs/meson.build` - Add `RunCommand/Overlay.vala` to valadoc source list (after `RunCommand/Monitor.vala`, before `RunCommand/Request.vala`)
