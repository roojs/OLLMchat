...
- **Base class**: `liboctools/RequestRunCommand.vala` - uses virtual methods `send_initial_tool_message()` and `send_or_append_message()` (namespace: `OLLMtools`)
...
- **Single base class**: `liboctools/RequestRunCommand.vala` - sends markdown code blocks via `tool_message()` (namespace: `OLLMtools`)
...
**File**: `liboctools/RequestRunCommand.vala` (namespace: `OLLMtools`)
...
**File**: `liboctools/RunCommand.vala` (namespace: `OLLMtools`)
