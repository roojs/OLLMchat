...
⏳ **TODO** - Method signatures need updating.
...
- [1.2.6.3. Update TitleGenerator](./1.2.6.3-update-title-generator.md) - Will need updating after this
- [1.2.6.4. Update VectorBuilder](./1.2.6.4-update-vector-builder.md) - Will need updating after this
- [1.2.6.5. Update Database](./1.2.6.5-update-database.md) - Will need updating after this
- [1.2.6.6. Update Search](./1.2.6.6-update-search.md) - Will need updating after this
