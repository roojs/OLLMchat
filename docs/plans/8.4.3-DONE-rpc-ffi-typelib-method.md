...
**Leftovers:** [`8.4.4`](8.4.4-rpc-invoke-errors.md) (invoke errors), [`8.4.5`](8.4.5-rpc-ffi-leftovers.md) (`INTERFACE` return tag, object args / `append`), [`8.4.6`](8.4.6-rpc-ffi-leftovers.md) (float, array, width).
...
- **🔷** `⏳` `Gi.scalar` — TypeTag switch that turns one `GI.Argument` into a `GLib.Value` (the reverse of `convert`). Used for the return and for each **out** argument. Tags:
  ...
  - `UTF8` / `FILENAME`
- **ℹ️** Object-as-arg / boxed `INTERFACE` → [`8.4.5`](8.4.5-rpc-ffi-leftovers.md). Float / array / width → [`8.4.6`](8.4.6-rpc-ffi-leftovers.md). The fenced `TypeTag.OBJECT` branch does not compile — leftover 8.4.5. Invoke throw → [`8.4.4`](8.4.4-rpc-invoke-errors.md).
...
- **ℹ️** Fenced `GI.TypeTag.OBJECT` is leftover [`8.4.5`](8.4.5-rpc-ffi-leftovers.md) (`INTERFACE` only). Invoke return pointer is there too. Float / array / width → [`8.4.6`](8.4.6-rpc-ffi-leftovers.md).
