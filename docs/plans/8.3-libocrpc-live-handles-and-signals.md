...
- **🔷** `✔️` [`8.3.1`](8.3.1-live-handles-and-remote-refcount.md) — live handles and remote refcount (`export`, `Remote.ref` / `Remote.unref`, `live_handles` flag).
...
- **🔷** `⏳` When the flag is **on**, serialize may emit handles and the GObject payload. Subscribe and `Remote.ref` / `Remote.unref` are valid. ([`8.3.2`](8.3.2-subscribe-unsubscribe.md), [`8.3.3`](8.3.3-notification-gobject-payload.md))
