...
- **2.10.4.7** — Active project and file outside the database ([`2.10.4.7-FUTURE-active-project-file-outside-db.md`](2.10.4.7-FUTURE-active-project-file-outside-db.md)) — daemon cutover follow-up; this plan owns **persistence** of open project/file in agent config / session state (not SQLite)
