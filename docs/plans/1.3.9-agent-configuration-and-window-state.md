...
- **2.10.4.7** - Active project/file state client-only ([`2.10.4.7-active-state-client-only.md`](2.10.4.7-active-state-client-only.md)) — daemon cutover follow-up; this plan owns **persistence** of open project/file in agent config
