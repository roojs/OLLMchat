...
### Core Tool Files
- `libollmchat/Tools/WebFetchTool.vala` - Main tool class extending `OLLMchat.Tool.Interface`
- `libollmchat/Tools/RequestWebFetch.vala` - Request handler class extending `OLLMchat.Tool.RequestBase`

### File Structure
```
libollmchat/Tools/
├── WebFetchTool.vala          (new - main tool class)
└── RequestWebFetch.vala        (new - request handler)
```

## Implementation Tasks

### 1. Create WebFetchTool.vala
- **Location**: `libollmchat/Tools/WebFetchTool.vala`
...
- **Location**: `libollmchat/Tools/RequestWebFetch.vala`
- **Namespace**: `OLLMchat.Tools`
...
- **Implementation notes**:
  ...
  - Create `OLLMchat.Tools.WebFetchTool` instance
...
- [ ] Step 1: Create WebFetchTool.vala - Check coding standards after completion
- [ ] Step 2: Create RequestWebFetch.vala - Check coding standards after completion
- [ ] Step 3: Implement HTTP fetching - Check coding standards after completion
- [ ] Step 4: Implement format conversion (use switch/case) - Check coding standards after completion
- [ ] Step 5: Implement permission system (domain-based) - Check coding standards after completion
- [ ] Step 6: Add error handling - Check coding standards after completion
- [ ] Step 7: Update meson.build - Verify build works
- [ ] Step 8: Register tool - Test tool appears
- [ ] Step 9: Create oc-test-fetch - Test command-line tool works
