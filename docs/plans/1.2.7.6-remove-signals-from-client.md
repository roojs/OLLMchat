...
⏳ **TODO** - Fifth phase of signal migration.
...
- [1.2.7.5. Rename exec_chat() to send()](./1.2.7.5-rename-exec-chat-to-send.md) - Previous phase
- [1.2.7.7. Remove Client from Session](./1.2.7.7-remove-client-from-session.md) - Next phase
