...
- `ChatDefaults.vala` - Chat-specific settings (low priority, NOT in Settings/)

### Rationale

- **Settings/** subdirectory: All ollmchat configuration classes go here (Connection, ModelOptions if needed)
...
- **ChatDefaults.vala**: At root level as it's chat options, not configuration settings
