...
ℹ️ Parent: [6.1.2](6.1.2-pi-like-agent.md) Phase 1 (inject omits when missing). Split out of former Phase 9.  
...
- ℹ️ Soft-cap for AGENTS inject size (% of model context) remains a **later** item on [02](6.1.2-pi-like-agent.md) suggested order — after this offer lands.
- 🔷 Agent id `agent-pi`.
