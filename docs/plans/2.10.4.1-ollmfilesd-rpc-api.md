...
| `vector.*` | ⏳ other methods; search → **`Codebase.search`** [`2.10.4.18`](2.10.4.18-ACTIVE-vector-search-rpc.md) |
| `Codebase.search` | ⏳ [`2.10.4.18`](2.10.4.18-ACTIVE-vector-search-rpc.md) |
| `Bubble.*` | ⏳ [`2.10.4.15`](2.10.4.15-ACTIVE-execution-rpc-sandbox.md) — after [`done/2.10.4.17`](done/2.10.4.17-DONE-libocbwrap-sandbox-library.md) library ✅ |
...
## `Codebase` — search relay ([`2.10.4.18`](2.10.4.18-ACTIVE-vector-search-rpc.md))

**🔷** Search only — wire object **`Codebase`** because **`OLLMfilesd.Vector`** is an indexing namespace, not an RPC class.

- **`Codebase.search`** — `Search.execute`, `RequestCodebaseSearch` — **⏳** [`2.10.4.18`](2.10.4.18-ACTIVE-vector-search-rpc.md)
