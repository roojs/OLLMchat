...
| `vector.*` | **ACTIVE** — [`2.10.4.29`](2.10.4.29-ACTIVE-vector-cli-rpc-migration.md); **`Codebase.search`** ✅; **`Codebase.start`**/**`stop`** **✔️** |
...
| **`Codebase.start`** | **`call_start`** | **✔️** | pause → enqueue stale from DB → resume (**🚫** no **`read_dir`**) |
