...
| [`2.10.4.32`](2.10.4.32-FUTURE-multi-window-support.md) | **FUTURE** — second window + per-window Config2 rows |
...
- Per-window active file / cursor / scroll ([`2.10.4.7`](done/2.10.4.7-DONE-active-project-file-outside-db.md); multi-window [`2.10.4.32`](2.10.4.32-FUTURE-multi-window-support.md))
