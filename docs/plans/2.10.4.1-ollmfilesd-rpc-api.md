...
| [`2.10.4.7`](2.10.4.7-URGENT-active-project-file-outside-db.md) | **URGENT** — active project/file off daemon; Config2 `Window`; drop `File.activate` |
...
- Per-window active file / cursor / scroll ([`2.10.4.7`](2.10.4.7-URGENT-active-project-file-outside-db.md))
