...
- **`Folder.fetch_files`** — paged dropdown — **B-10** in [`2.10.4.9`](2.10.4.9-ACTIVE-v2-caller-cutover.md) (**`FolderParams`**: existing **`path`**; new **`offset`**, **`limit`**, **`query`**; **`msg`** = total count)
- **`Codebase.search`**
