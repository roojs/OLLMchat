...
- [ ] Stdin format (all edits come from stdin):
...
Create `tests/data/` directory with test data files:
...
- [ ] **Test 1: Complete file mode (new file creation)**
  ...
  - Pipes content to stdin: `echo "line 1\nline 2\nline 3" | oc-test-files --edit=~/.cache/ollmchat/testing/test_new.txt --edit-complete-file --backend sourceview --test-db ~/.cache/ollmchat/testing/test.db`
...
- [ ] **Test 2: Complete file mode (overwrite existing file in project)**
  - Creates test file in `~/.cache/ollmchat/testing/testproj2/test.txt`
  ...
  - Overwrites with: `echo "new content" | oc-test-files --edit=~/.cache/ollmchat/testing/testproj2/test.txt --edit-complete-file --overwrite --backend sourceview --test-db ~/.cache/ollmchat/testing/test.db`
...
- [ ] **Test 3: Edit mode (single edit)**
  - Creates test file with known content in `~/.cache/ollmchat/testing/testproj3/test.txt`
  - Creates project: `oc-test-files --create-project ~/.cache/ollmchat/testing/testproj3 --test-db ~/.cache/ollmchat/testing/test.db`
  - Applies single edit by piping JSON to stdin: `echo '[{"start": 2, "end": 4, "replacement": "new line 2\nnew line 3\n"}]' | oc-test-files --edit=~/.cache/ollmchat/testing/testproj3/test.txt --backend sourceview --test-db ~/.cache/ollmchat/testing/test.db`
...
- [ ] **Test 4: Edit mode (multiple edits)**
  - Creates test file with known content in `~/.cache/ollmchat/testing/testproj4/test.txt`
  - Creates project: `oc-test-files --create-project ~/.cache/ollmchat/testing/testproj4 --test-db ~/.cache/ollmchat/testing/test.db`
  - Applies multiple edits by piping JSON to stdin: `echo '[{"start": 2, "end": 4, "replacement": "new content\n"}, {"start": 10, "end": 10, "replacement": "inserted line\n"}]' | oc-test-files --edit=~/.cache/ollmchat/testing/testproj4/test.txt --backend sourceview --test-db ~/.cache/ollmchat/testing/test.db`
  - Verify backup is created
...
- [ ] **Test 5: Edit mode (insertion at end of file)**
  - Creates test file with known content in `~/.cache/ollmchat/testing/testproj5/test.txt`
  ...
  - Pipes JSON to stdin: `echo '[{"start": N, "end": N, "replacement": "appended line\n"}]' | oc-test-files --edit=~/.cache/ollmchat/testing/testproj5/test.txt --backend sourceview --test-db ~/.cache/ollmchat/testing/test.db` (where N = last_line+1)
  - Verify backup is created
