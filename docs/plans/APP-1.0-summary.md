...
> Category index for **APP** (`ollmapp`). Do not list in-progress sub-plans here until they are done and archived.

**Prefix:** `APP` · **All categories:** [`-README.md`](-README.md)
...
- [APP-1.3.9-agent-configuration-and-window-state.md](APP-1.3.9-agent-configuration-and-window-state.md)
- [APP-1.30-chat-input-composer.md](APP-1.30-chat-input-composer.md)
- [APP-1.30.1-chatinput-preedit-speech.md](APP-1.30.1-chatinput-preedit-speech.md)
...
- [APP-4.3-glade-ui-editor.md](APP-4.3-glade-ui-editor.md)
- [APP-4.4-roobuilder.md](APP-4.4-roobuilder.md)
- [APP-4.6-image-generation-and-manipulation.md](APP-4.6-image-generation-and-manipulation.md)
