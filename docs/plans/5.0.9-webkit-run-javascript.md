...
- ℹ️ Permission UX precedent: `ChatPermission` Allow / Deny / Always (`libollmchat/ChatPermission/`); press uses standard chat bar ([`5.0.3`](5.0.3-DEFERRED-webkit-press-permission-overlay.md) overlay still deferred)
...
- Do not update **`1.0-summary.md`** until this plan is done and archived.
