...
**Parent:** [`8.0-libollmchat-local-gguf-backend.md`](8.0-libollmchat-local-gguf-backend.md) · **Layout:** [`guide-to-writing-plans.md`](../guide-to-writing-plans.md) · **Pointer:** `docs/coding-standards.md` — Checklist for all plans
