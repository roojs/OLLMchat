...
- **done/2.20.3-DONE-binary-file-image-analysis.md** – Image analysis, vision API, and chat image support; PDF extraction reuses the same image pipeline.
- **done/2.20-DONE-codebase-scanner-improvements.md** – Parent codebase scanner context.
