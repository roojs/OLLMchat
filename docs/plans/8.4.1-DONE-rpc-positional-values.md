...
**Source:** `gnome-shell-rpc` [](file:///home/alan/git/gnome-shell-rpc/docs/plans/0.5.1-runtime-helpers-and-positional-args.md)`0.5.1` — positional args. Direction is **not** on the wire; the reader (hand handler or GIR in `[8.4.2](8.4.2-DONE-rpc-ffi-typelib-invoke.md)`) already knows the signature.
...
- **ℹ️** IN/OUT/INOUT from GIR in [`8.4.2`](8.4.2-DONE-rpc-ffi-typelib-invoke.md) / [`8.4.3`](8.4.3-DONE-rpc-ffi-typelib-method.md).
