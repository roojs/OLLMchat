...
**Status:** **✔️** basic v1 implemented — help lists `download`; fences below are the shipped shape
...
- ℹ️ Progress Cancel / Pause banner: [`5.0.6-URGENT-activity-progress-actions.md`](5.0.6-URGENT-activity-progress-actions.md)
- ℹ️ Windows / Android: [`5.0.1`](5.0.1-windows-webkit-accessibility.md), [`5.0.2`](5.0.2-android-webkit-control.md)
...
- **ℹ️** History / open → **[`5.0.7`](5.0.7-webkit-download-advanced.md)**. Cancel button → **[`5.0.6`](5.0.6-URGENT-activity-progress-actions.md)** (`downloads_active`).
...
6. **⏳** **🔷** Windows / Android parity later
