...
4. Update `SessionPlaceholder` and `EmptySession` to support both patterns
...
1. Update UI code to create Message objects and call `manager.send(fid, message)` - new preferred method
...
4. Test UI still works with both old and new patterns
...
8. Update documentation/comments that reference removed methods
