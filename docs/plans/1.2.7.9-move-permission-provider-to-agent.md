...
⏳ **TODO** - Move permission provider from Chat to AgentHandler.
...
- [1.2.7.4. Migrate Tool Signal Connections to Direct Method Calls](./1.2.7.4-migrate-non-agent-signals.md) - Adds agent property to tools
