...
- `libollmchat/Prompt/AgentHandler.vala` - Add `execute_tool()` method
...
- [1.2.7.4. Migrate Tool Signal Connections to Direct Method Calls](./1.2.7.4-migrate-non-agent-signals.md) - Previous phase (tools now use agent property)
