...
**Next:** [`8.4.3`](8.4.3-DONE-rpc-ffi-typelib-method.md). Leftovers: [`8.4.4`](8.4.4-rpc-invoke-errors.md) (invoke errors), [`8.4.5`](8.4.5-rpc-ffi-leftovers.md) (boxed / GObject `INTERFACE` / invoke return), [`8.4.6`](8.4.6-rpc-ffi-leftovers.md) (float, array, width).
...
- **ℹ️** Constructor-with-args (`Gio-SimpleAction.new`) / `INTERFACE` args → [`8.4.5`](8.4.5-rpc-ffi-leftovers.md).
...
- **🔷** Phase 2 tags in `convert`: `BOOLEAN`, `INT32`/`INT64`, `UINT32`/`UINT64`, `UTF8`/`FILENAME`. `INTERFACE` (GObject / boxed) → [`8.4.5`](8.4.5-rpc-ffi-leftovers.md). `ARRAY` / float / `GValue.transform` width → [`8.4.6`](8.4.6-rpc-ffi-leftovers.md).
...
- **ℹ️** `fn.invoke` `return_value` by value — leftover [`8.4.5`](8.4.5-rpc-ffi-leftovers.md). Constructor-with-args / `INTERFACE` also there. `ARRAY` / float / width → [`8.4.6`](8.4.6-rpc-ffi-leftovers.md). Invoke throw → client is [`8.4.4`](8.4.4-rpc-invoke-errors.md).
