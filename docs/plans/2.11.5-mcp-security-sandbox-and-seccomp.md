...
This plan is separate from loader/wiring work ([2.11.2](2.11.2-DONE-mcp-loader.md)–[2.11.4](2.11.4-mcp-meson-and-app-wiring.md)) so security can be reviewed and implemented without blocking core MCP integration.
...
- [2.11.3](2.11.3-DONE-mcp-clients-and-factories.md) — `Client.Stdio` spawn path exists (review target).
...
- Implementing [2.11.2](2.11.2-DONE-mcp-loader.md) Loader / Tool / Registry wiring (done).
