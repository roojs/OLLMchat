...
- **🔷** Phase 3: add **`Response.retval`** (`GLib.Value`) beside **`result`**. Split: [`8.5.3`](8.5.3-rpc-response-value.md). Do not replace `result` in that cut.
...
**ℹ️** Split to [`8.5.3-rpc-response-value.md`](8.5.3-rpc-response-value.md). Add `retval`; keep `result`. Do not duplicate the contract here.
...
- **🔷** `⏳` **8.5.3** — [`8.5.3-rpc-response-value.md`](8.5.3-rpc-response-value.md) — add `retval`; keep `result`.
