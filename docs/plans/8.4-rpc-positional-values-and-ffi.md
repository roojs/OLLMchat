...
**Status:** **PROPOSED** — parent. [`8.4.1`](8.4.1-DONE-rpc-positional-values.md) / [`8.4.2`](8.4.2-DONE-rpc-ffi-typelib-invoke.md) / [`8.4.3`](8.4.3-DONE-rpc-ffi-typelib-method.md) / [`8.4.5`](8.4.5-DONE-rpc-ffi-leftovers.md) / [`8.4.6`](8.4.6-DONE-rpc-ffi-leftovers.md) agent **✔️**. [`8.4.9`](8.4.9-rpc-ffi-glist-in.md) list IN (GObject / utf8 / boxed) + utf8 list OUT agent **✔️**. [`8.4.4`](8.4.4-rpc-invoke-errors.md) / [`8.4.7`](8.4.7-rpc-ffi-inout.md) / [`8.4.8`](8.4.8-rpc-live-gtype-explicit-alias.md) still open. Sub-plan files stay in this folder until the 8.4 range is archived.
...
**Related:** [`docs/bin-rpc-protocol.md`](../bin-rpc-protocol.md) (v3.0) — document optional `Request.values` when present. **No protocol version bump.** [`8.5`](8.5-rpc-drop-callparam-reply-value.md) — drop `CallParam` / `Request.param`; `Response.result` → `GLib.Value`. Not this parent.
...
**Suggested order:** [`8.4.1`](8.4.1-DONE-rpc-positional-values.md) → [`8.4.2`](8.4.2-DONE-rpc-ffi-typelib-invoke.md) → [`8.4.3`](8.4.3-DONE-rpc-ffi-typelib-method.md) → [`8.4.4`](8.4.4-rpc-invoke-errors.md) / [`8.4.5`](8.4.5-DONE-rpc-ffi-leftovers.md) → [`8.4.6`](8.4.6-DONE-rpc-ffi-leftovers.md) → [`8.4.9`](8.4.9-rpc-ffi-glist-in.md) (list IN) / [`8.4.7`](8.4.7-rpc-ffi-inout.md) / [`8.4.8`](8.4.8-rpc-live-gtype-explicit-alias.md). CallParam removal is [`8.5`](8.5-rpc-drop-callparam-reply-value.md).

---

## Phase summary

- **🔷** `✔️` [`8.4.1`](8.4.1-DONE-rpc-positional-values.md) — `Request.values` as `Gee.ArrayList<GLib.Value?>`; `ANY[]` on the wire; `param` unchanged.
- **🔷** `✔️` [`8.4.2`](8.4.2-DONE-rpc-ffi-typelib-invoke.md) — typelib register + RPC `Alias.new` in `Gi` (`windows/Gi.vala` via meson).
...
- **🔷** `✔️` [`8.4.3`](8.4.3-DONE-rpc-ffi-typelib-method.md) — any typelib method on that lease (`dispatch_function`, `Request.lease_id`, `Response.values` / `Gi.scalar`).
- **🔷** `⏳` [`8.4.4`](8.4.4-rpc-invoke-errors.md) — invoke `GLib.Error` on the wire; client emits the type the stub `throws`.
- **🔷** `✔️` [`8.4.5`](8.4.5-DONE-rpc-ffi-leftovers.md) — boxed blob + GObject `INTERFACE` (`TypeTag.INTERFACE` split). Invoke return uses local `g_function_info_invoke` (`out GI.Argument`); system vapi still by-value.
- **🔷** `✔️` [`8.4.6`](8.4.6-DONE-rpc-ffi-leftovers.md) — slabs, float/double, arrays, narrow ints, ENUM/FLAGS, list **OUT** (`scalar_list` / `scalar_hash`).
- **🔷** `✔️` [`8.4.9`](8.4.9-rpc-ffi-glist-in.md) — `GLIST` / `GSLIST` **IN** (lease-id GObject, unboxed `string[]` utf8, Variant `"aay"` boxed) and utf8 list **OUT**.
- **🔷** `⏳` [`8.4.7`](8.4.7-rpc-ffi-inout.md) — INOUT arguments.
- **🔷** `⏳` [`8.4.8`](8.4.8-rpc-live-gtype-explicit-alias.md) — live GObject: consumer explicitly maps concrete server GTypes to an existing typelib wire alias.
...
- **🚫** Change `Request.register`, `Client.call`, or ollmfilesd `*Params` in **this** range — that cut is [`8.5`](8.5-rpc-drop-callparam-reply-value.md).
