...
- **🔷** `✔️` [`8.4.9`](8.4.9-rpc-ffi-glist-in.md) — `GLIST` / `GSLIST` **IN** Priority A (lease-id arrays → real lists). utf8/boxed later.
