...
**Suggested order:** [`8.4.1`](8.4.1-DONE-rpc-positional-values.md) → [`8.4.2`](8.4.2-DONE-rpc-ffi-typelib-invoke.md) → [`8.4.3`](8.4.3-DONE-rpc-ffi-typelib-method.md) → [`8.4.4`](8.4.4-rpc-invoke-errors.md) / [`8.4.5`](8.4.5-DONE-rpc-ffi-leftovers.md) → [`8.4.6`](8.4.6-rpc-ffi-leftovers.md) → [`8.4.7`](8.4.7-rpc-ffi-inout.md). CallParam removal is [`8.5`](8.5-rpc-drop-callparam-reply-value.md).
...
- **🔷** `⏳` [`8.4.6`](8.4.6-rpc-ffi-leftovers.md) — slabs, float/double, arrays, narrow ints, ENUM/FLAGS, `GLIST` / `GSLIST` / `GHASH`.
