...
**Status:** **PROPOSED** — parent. [`8.4.1`](8.4.1-DONE-rpc-positional-values.md) agent **✔️**. [`8.4.2`](8.4.2-rpc-ffi-typelib-invoke.md) / [`8.4.3`](8.4.3-rpc-ffi-typelib-method.md) still open. Sub-plan files stay in this folder until the 8.4 range is archived.
...
**Suggested order:** [`8.4.1`](8.4.1-DONE-rpc-positional-values.md) → [`8.4.2`](8.4.2-rpc-ffi-typelib-invoke.md) → [`8.4.3`](8.4.3-rpc-ffi-typelib-method.md).
...
- **🔷** `⏳` [`8.4.2`](8.4.2-rpc-ffi-typelib-invoke.md) — typelib register + RPC `Alias.new` in `Gi` (`windows/Gi.vala` via meson).
...
- **🔷** `⏳` [`8.4.3`](8.4.3-rpc-ffi-typelib-method.md) — any typelib method on that lease (`dispatch_function`, `Request.lease_id`, `Response.values` / `Gi.scalar`).
