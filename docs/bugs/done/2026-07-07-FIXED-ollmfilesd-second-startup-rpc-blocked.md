...
- [`docs/plans/done/2.10.4.30-DONE-startup-and-daemon-status-ui.md`](../../plans/done/2.10.4.30-DONE-startup-and-daemon-status-ui.md) — status UI for scan/activate (follow-up)
...
| **Scan status UI** | [`docs/plans/done/2.10.4.30-DONE-startup-and-daemon-status-ui.md`](../../plans/done/2.10.4.30-DONE-startup-and-daemon-status-ui.md) |
