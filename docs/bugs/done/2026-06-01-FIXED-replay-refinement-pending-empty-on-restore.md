...
**Pointer:** **`docs/guide-to-writing-plans.md`** (checklist for plans; Vala code: **`docs/coding-standards.md`**); **`docs/guide-to-writing-plans.md`** (Keep / Remove / Replace with); **`docs/bug-fix-process.md`**.
