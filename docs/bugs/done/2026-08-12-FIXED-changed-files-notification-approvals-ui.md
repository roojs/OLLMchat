...
ℹ️ Prior related: [`2026-07-27-FIXED-write-file-no-project-index-ui.md`](2026-07-27-FIXED-write-file-no-project-index-ui.md)
...
🚫 Reverted `File.fetch` → `all_files` workaround. Real fix tracked in [`2026-08-13-FIXED-is-text-content-type-fallback.md`](2026-08-13-FIXED-is-text-content-type-fallback.md) (GIO/system content-type on write/`to_real`).
...
Follow-on (open editor not reloading after LLM write): [`2026-08-15-FIXED-open-file-not-reloaded-after-llm-write.md`](2026-08-15-FIXED-open-file-not-reloaded-after-llm-write.md)
