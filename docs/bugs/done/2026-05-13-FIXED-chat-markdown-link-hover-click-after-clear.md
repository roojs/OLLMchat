...
ℹ️ **`docs/guide-to-writing-plans.md`** · **`docs/bug-fix-process.md`** · **`docs/coding-standards.md`** (**Checklist for plans** in **`docs/guide-to-writing-plans.md`** and Vala rules in **`docs/coding-standards.md`** before implement).
