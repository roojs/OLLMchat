...
- ✔️ 2026-08-22 — [32441247618](https://github.com/roojs/OLLMchat/actions/runs/32441247618), [32441610454](https://github.com/roojs/OLLMchat/actions/runs/32441610454): R14 discarded pango; Meson download then failed `wrap-redirect … pango/subprojects/freetype2.wrap does not exist`. Clone pango/libadwaita at their pins before Meson download. R16 asserts the pin tree has that wrap file.
- ⏳ GitHub `Release - Android` after R16.
